...
// Full-screen-ish "Analyzing…" state with pulse dots, a status line from
// the caller, and a fixed hint about expected duration. Used during
// network round-trips (Anthropic photo / text analysis).
