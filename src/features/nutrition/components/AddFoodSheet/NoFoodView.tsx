...
function NoFoodIcon({ color, size = 48 }: { color: string; size?: number }) {
  return (
...
export function NoFoodView({ notes, source, onStartOver }: NoFoodViewProps) {
  const subtitle =
    source === 'photo'
