...
export default function WorkoutActivity(props, _env) {
  ...
  // Centralised so we describe "DONE / RUNNING / IDLE" once and apply a
  // size/colour preset per surface (compact, lock-screen banner).
  ...
  // `compactLeading` carries the live status; `compactTrailing` carries
  // the small "X/Y" set counter. These are also reused as the expanded
  // slots — see header comment for rationale.
  ...
  // ── Lock-screen banner ────────────────────────────────────────────────
  // The full-context surface — exercise name, day title, set position,
  // status, and progress bar. This is the only place the user gets the
  // "what am I in the middle of" picture.
  var banner = (
  ...
  // ── Output ────────────────────────────────────────────────────────────
  // expanded* slots intentionally mirror the compact ones; expandedBottom
  // is omitted so long-press doesn't grow the surface vertically.
  return {
    banner: banner,
