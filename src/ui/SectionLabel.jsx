 ...
 *
 * @param {object} props
 * @param {React.ReactNode} props.children - The label text (typically already uppercase).
 * @param {import('react-native').StyleProp<import('react-native').TextStyle>} [props.style] - Style override (e.g. extra marginTop).
 *
 * @example
